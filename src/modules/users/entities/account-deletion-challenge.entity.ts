...
@Entity('account_deletion_challenges')
@Index('idx_account_deletion_challenges_active', ['userId'], {
...
export class AccountDeletionChallenge {
  ...
  @Index('idx_account_deletion_challenges_link_token_hash')
